        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            ...
            <div class="grid grid-cols-12 gap-6 intro-y box p-5">
                ...
                <div class="sm:col-span-8 col-span-12">
                    <form class="validate-form" id="create-user-form" action="{{ route('dashboard-pembelajaran-guru-dan-tendik-simpan') }}" method="POST" enctype="multipart/form-data">
                        @if(session('errors'))
                        ...
                        <div id="informasi-akun-section">
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 md:col-span-6 intro-x">
                                    ...
                                    <input id="email" name="email" type="email" class="input w-full border mt-2" placeholder="Input Email" required>
                                </div>
                                <div class="col-span-12 md:col-span-6 intro-x">
                                    <label for="password">Password</label>
                                    <input id="password" name="password" type="password" class="input w-full border mt-2" placeholder="Input Password" minlength="8" required>
                                </div>
                                <div class="col-span-12 md:col-span-6 intro-x">
                                    <label for="password_confirmation">Konfirmasi Password</label>
                                    <input id="password_confirmation" name="password_confirmation" type="password" class="input w-full border mt-2" placeholder="Input Konfirmasi Password" minlength="8" required>
                        ...
                        <div id="informasi-pribadi-section">
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-3">
                                <div class="col-span-12 md:col-span-6 intro-x">
                                    ...
                                    <input id="name" name="name" type="text" class="input w-full border mt-2" placeholder="Input Nama Lengkap" required>
                                </div>
                                <div class="col-span-12 md:col-span-6 lg:col-span-3 intro-x">
                                    <label for="nip">NIP</label>
                                    <input id="nip" name="nip" type="number" class="input w-full border mt-2" placeholder="Input NIP" minlength="10" required>
                                </div>
                                <div class="col-span-12 md:col-span-6 lg:col-span-3 intro-x">
                                    <label for="nrk">NRK</label>
                                    <input id="nrk" name="nrk" type="number" class="input w-full border mt-2" placeholder="Input NRK" minlength="6" required>
                                </div>
                                <div class="col-span-12 md:col-span-6 intro-x">
                                    <label for="no_hp">No HP</label>
                                    <input id="no_hp" name="no_hp" type="text" class="input w-full border mt-2" placeholder="Input No HP" required>
                                </div>
                                <div class="col-span-12 md:col-span-6 lg:col-span-3 intro-x">
                                    <label for="tempat_lahir">Tempat Lahir</label>
                                    <input id="tempat_lahir" name="tempat_lahir" type="text" class="input w-full border mt-2" placeholder="Input Tempat Lahir" required>
                                </div>
                                <div class="col-span-12 md:col-span-6 lg:col-span-3 intro-x">
                                    <label for="tanggal_lahir">Tanggal Lahir</label>
                                    <input id="tanggal_lahir" name="tanggal_lahir" class="datepicker input w-full border mt-2" placeholder="Input Tanggal Lahir" required>
                                </div>
                                <div class="col-span-12 intro-x">
                                    <label for="alamat">Alamat</label>
                                    <textarea id="alamat" name="alamat" class="input w-full border mt-2" placeholder="Input Alamat" rows="4" required></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-span-12 intro-x">
                                    <div class="border border-gray-200 rounded-md p-5">
                                        ...
                                        <div class="w-40 mx-auto cursor-pointer relative mt-5">
                                            ...
                                            <input id="foto-input" name="avatar" type="file" accept=".png, .jpg, .jpeg" class="w-full h-full top-0 left-0 absolute opacity-0" required>
                                        </div>
                                    </div>
                                </div>
                            </div>

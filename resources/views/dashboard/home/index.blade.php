                                ...
                                <div class="table-responsive ">
                                    <table class="table patient-activity flex-nowrap">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center flex-wrap">
                                                    <img class="me-3 img-fluid rounded" width="78" src="./images/avatar/2.jpg" alt="DexignZone">
                                                    <div class="media-body">
                                        ...
                                        <tr class="active">
                                            <td>
                                                <div class="media align-items-center flex-wrap">
                                                    <img class="me-3 img-fluid rounded" width="78" src="./images/avatar/3.jpg" alt="DexignZone">
                                                    <div class="media-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center flex-wrap">
                                                    <img class="me-3 img-fluid rounded" width="78" src="./images/avatar/4.jpg" alt="DexignZone">
                                                    <div class="media-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center flex-wrap">
                                                    <img class="me-3 img-fluid rounded" width="78" src="./images/avatar/5.jpg" alt="DexignZone">
                                                    <div class="media-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media align-items-center flex-wrap">
                                                    <img class="me-3 img-fluid rounded" width="78" src="./images/avatar/6.jpg" alt="DexignZone">
                                                    <div class="media-body">

...
(function($) {
    ...
    versionSelect.on('change', function() {
		body.attr('data-theme-version', this.value);
		 ...
		 if(this.value === 'dark'){
			...
			jQuery(".nav-header .logo-abbr").attr("src", "/images/layout/logo-sekolah.png");
			jQuery(".nav-header .logo-compact").attr("src", "/images/layout/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "/images/layout/logo-text-white.png");
			
			setCookie('logo_src', '/images/layout/logo-sekolah.png');
			setCookie('logo_src2', '/images/layout/logo-text-white.png');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "/images/layout/logo-sekolah.png");
			jQuery(".nav-header .logo-compact").attr("src", "/images/layout/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src", "/images/layout/logo-text.png");
			
			setCookie('logo_src', '/images/layout/logo-sekolah.png');
			setCookie('logo_src2', '/images/layout/logo-text.png');
		} 
    ...
    jQuery("#nav_header_color_1").on('click',function(){
		jQuery(".nav-header .logo-abbr").attr("src", "/images/layout/logo-sekolah.png");
		jQuery(".nav-header .logo-compact, .nav-header .brand-title").attr("src", "/images/layout/logo-text.png");
		setCookie('logo_src', '/images/layout/logo-sekolah.png');
		setCookie('logo_src2', '/images/layout/logo-text.png');
		return false;
    });
	...
	jQuery("#nav_header_color_2, #nav_header_color_3, #nav_header_color_4, #nav_header_color_5, #nav_header_color_6, #nav_header_color_7, #nav_header_color_8, #nav_header_color_9, #nav_header_color_10, #nav_header_color_11, #nav_header_color_12, #nav_header_color_13, #nav_header_color_14, #nav_header_color_15").on('click',function(){
		jQuery(".nav-header .logo-abbr").attr("src", "/images/layout/logo-sekolah.png");
		jQuery(".nav-header .logo-compact, .nav-header .brand-title").attr("src", "/images/layout/logo-text-white.png");
		setCookie('logo_src', '/images/layout/logo-sekolah.png');
		setCookie('logo_src2', '/images/layout/logo-text-white.png');
		return false;
    });

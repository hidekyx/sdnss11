...
(function($) {
    ...
    versionSelect.on('change', function() {
		body.attr('data-theme-version', this.value);
		 ...
		 if(this.value === 'dark'){
			...
			jQuery(".nav-header .logo-compact").attr("src", "../../images/layout/logo-sekolah.png");
			jQuery(".nav-header .brand-title").attr("src", "../../images/layout/logo-sekolah.png");
			
			setCookie('logo_src', '.../../images/layout/logo-sekolah.png');
			setCookie('logo_src2', '../../images/layout/logo-sekolah.png');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "../../images/layout/logo-sekolah.png");
			jQuery(".nav-header .logo-compact").attr("src", "../../images/layout/logo-sekolah.png");
			jQuery(".nav-header .brand-title").attr("src", "../../images/layout/logo-sekolah.png");
    ...
    jQuery("#nav_header_color_1").on('click',function(){
		jQuery(".nav-header .logo-abbr").attr("src", "../../images/layout/logo-sekolah.png");
		jQuery(".nav-header .logo-compact, .nav-header .brand-title").attr("src", "../../images/layout/logo-sekolah.png");
		setCookie('logo_src', '../../images/layout/logo-sekolah.png');
		setCookie('logo_src2', '../../images/layout/logo-sekolah.png');
		return false;
    });

    ...
    return {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each((function() {
                ...
                function() {
                    ...
                    var t = $("input[name='" + fieldName + "']"),
                        o = parseInt(t.val());
                    isNaN(o) ? t.val(0) : "minus" == type ? t.val(o - 1) : "plus" == type && t.val(o + 1)
                    ...
                    $.ajax({
                        ...
                        dataType: "html",
                        success: function(e) {
                            $("#" + o + "Content").append(e), $(".dz-load-more i").remove()
                        }
                    })
                ...
                })), t(), jQuery("select").selectpicker(), $(".dz-demo-trigger").on("click", (function() {
                ...
                function() {
                    if (jQuery(".dz-theme-mode").length > 0) {
                        jQuery(".dz-theme-mode").on("click", (function() {
                            jQuery(this).toggleClass("active"), jQuery(this).hasClass("active") ? (jQuery("body").attr("data-theme-version", "dark"), setCookie("version", "dark"), jQuery("#theme_version").val("dark"), jQuery(".nav-header .logo-abbr").attr("src", "/images/layout/logo-sekolah.png"), jQuery(".nav-header .logo-compact").attr("src", "/images/layout/logo-text-white.png"), jQuery(".nav-header .brand-title").attr("src", "/images/layout/logo-text-white.png"), setCookie("logo_src", "/images/layout/logo-sekolah.png"), setCookie("logo_src2", "/images/layout/logo-text-white.png")) : (jQuery("body").attr("data-theme-version", "light"), setCookie("version", "light"), jQuery("#theme_version").val("light"), jQuery(".nav-header .logo-abbr").attr("src", "/images/layout/logo-sekolah.png"), jQuery(".nav-header .logo-compact").attr("src", "/images/layout/logo-text.png"), jQuery(".nav-header .brand-title").attr("src", "/images/layout/logo-text.png"), setCookie("logo_src", "/images/layout/logo-sekolah.png"), setCookie("logo_src2", "/images/layout/logo-text.png")), $(".default-select").selectpicker("refresh")
                        }));
                        var e = getCookie("version");
                        jQuery("body").attr("data-theme-version", e), jQuery(".dz-theme-mode").removeClass("active"), setTimeout((function() {
        ...
        handleMenuPosition: function() {
            e > 1024 && $(".metismenu  li").unbind().each((function(e) {
                if ($("ul", this).length > 0) {
                    var t = (n = $("ul:first", this).css("display", "block")).offset().left,
                        o = n.width(),
                        n = $("ul:first", this).removeAttr("style"),
                        s = ($("body").height(), $("body").width());
                    if (jQuery("html").hasClass("rtl")) var a = t + o <= s;
                    else a = t > 0;
                    a ? $(this).find("ul:first").removeClass("left") : $(this).find("ul:first").addClass("left")
                }
            }))
        }
    }
